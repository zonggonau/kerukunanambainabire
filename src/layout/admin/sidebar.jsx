    ...
    <>
      ...
      >
        <div className="h-full px-3 py-10 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          <ul className="space-y-2 font-medium pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            <li>
              <Link
                href="/admin/blog"
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Blog Post</span>
